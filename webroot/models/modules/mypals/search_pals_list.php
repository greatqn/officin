<?php
	...
	$now_year=date('Y');
	if($memName!=''){
		$cols.=" and (user_name like '%$search_name%' or cn_name like '%$search_name%')";
	}
	...
	$sql="select user_id,user_name,user_sex,birth_province,birth_city,reside_province,reside_city,user_ico,cn_name from $table where $cols ";		
