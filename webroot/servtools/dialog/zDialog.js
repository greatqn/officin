...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; border:6px solid #777; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td height="40" style="background:#0063B0;"><div style="padding: 5px 0 0 16px; float: left; font-weight: bold; font-size:13px; color:#fff; "><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
