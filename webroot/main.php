...
if(filemtime("templates/default/main.html") > filemtime(__file__) || (file_exists("models/main.php") && filemtime("models/main.php") > filemtime(__file__)) ) {
	tpl_engine("default","main.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
