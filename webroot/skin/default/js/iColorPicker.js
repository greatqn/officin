...
var imageUrl='skin/default/js/color.png';
...
jQuery('#color').val(def);var hxs=jQuery('#iColorPicker');
...
function(a){var aaa="#"+jQuery(this).attr('hx');
...
jQuery("#iColorPicker").fadeOut();jQuery(this)})}}}}

this.iColorPicker=function(){
jQuery("input.iColorPicker").each(
function(i){
if(i==0){
...
jQuery(this).after('<input type="hidden" id="icp_'+this.id+'" value="'+jQuery(this).val()+'">');
jQuery(this).css("backgroundColor",jQuery(this).val())
.css("color",jQuery(this).val()).click(function(){iColorShow("icp_"+this.id,this.id);});
jQuery(this).val('');
})};
