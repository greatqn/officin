...
$appArray=array(
		   ...
		   "blog_collect" => 'modules/blog/blog_collect.php',
		   ...
		   "mypals_referred" => 'modules/mypals/pals_referred.php',
		   ...
		   'buscard' => 'modules/mypals/buscard.php',
		   ...
		   "user_business_card" => 'modules/users/user_business_card.php',
		   "user_edit_card" => 'modules/users/user_edit_card.php',
		   ...
		   "msg_mbox" => 'modules/msgscrip/mbox.php',
		   "msg_gbox" => 'modules/msgscrip/gbox.php',
		   ...
		   'set_mycard' => 'modules/users/set_mycard.php',
		   'set_relation' => 'modules/users/set_relation.php',
		   'find_mypals' => 'modules/users/find_mypals.php',
       );  
